...
class Action_AdminEditEntity extends Action_Admin
{
    ...
    protected function sectionContent()
    {
        ?>
<h1>
	<a href="<?php echo call_user_func(array($this->listAction, 'lt')); ?>"><?php echo call_user_func(array(static::$entityClass, 'getPlural')); ?></a> &gt;&gt; <?php echo static::$entityClass ?> #<?php echo $this->id ?></h1>
<form class="form-horizontal" action="" enctype="multipart/form-data"
	...
	<?php if ($this->delete_form): ?>
		...
		<div class="form-group">
			<div class="col-md-12">
		  You are about to delete "<?php echo $this->entity ?>". <br /> This
				is <strong>not reversible</strong> operation. <br /> Please check
				the box and click Delete again to confirm.
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-3">&nbsp;</div>
			<div class="col-md-9 clearfix">
				<label for="confirm"> <input type="checkbox" name="confirm"
					id="confirm" value="confirm"> I am sure I want to delete this item.
				</label>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9 clearfix">
				<button id="delete" name="delete" class="pull-right btn btn-danger"
					value="delete">
	...
	<!-- Button (Double) -->
	    ...
	    <?php if($this->entity->id): ?>
	      <button id="save" name="save" value="save"
					class="pull-right btn btn-primary" style="margin-left: 10px;">
					<i class="fa fa-check"></i> Save
				</button>
	    <?php else: ?>
	      <button id="save" name="save" value="save"
					class="pull-right btn btn-success" style="margin-left: 10px;">
					<i class="fa fa-plus"></i> Add
				</button>
	    <?php endif; ?>
	    <a id="cancel"
					href="<?php echo call_user_func(array($this->listAction, 'lt')); ?>"
					class="pull-right btn btn-warning" style="margin-left: 90px;"><i
					class="fa fa-close"></i> Cancel</a>
	    <?php if($this->entity->id): ?>
	      <button id="delete" name="delete"
					class="pull-right btn btn-danger" value="delete">
					<i class="fa fa-trash"></i> Delete
				</button>
	    <?php endif; ?>
	  </div>
