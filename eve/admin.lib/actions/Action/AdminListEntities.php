...
<div class="col-md-4">
	...
	<p>
		<a class="btn btn-default" href="<?php echo static::lt() ?>"
			role="button">View <?php echo call_user_func(array(static::$entityClass, 'getPlural')) ?> &raquo;</a>
...
<h1>
	...
	<a class="btn btn-lg btn-success pull-right"
		href="<?php echo call_user_func(array($this->editAction, 'lt'), 0); ?>">
	      ...
	      <td>
				<div class="pull-right">
					<a class="btn btn-warning"
						href="<?php echo call_user_func(array($this->editAction, 'lt'), $entity->id); ?>">
						<span class="glyphicon glyphicon-edit"></span> Edit
					</a>&nbsp;<?php
            if (method_exists($entity, 'getUrl')) :
                ?><a class="btn btn-default" target="_blank"
						href="<?php echo $entity->getUrl(); ?>"> <span
						class="glyphicon glyphicon-share"></span> Preview
					</a>
		  <?php endif; ?>
	      </div>
			</td>
