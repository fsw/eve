...
class Action_Admin extends Action_HTML5
{
    ...
    public function run()
    {
        if ((get_class($this) != 'Action_AdminLogin') && empty($_SESSION['admin'])) {
            $this->redirectToWithReferer(Action_AdminLogin::lt());
        } else {
    ...
    protected function getStylesheetsUrls()
    {
        ...
        $ret[] = '/static/css/summernote.css';
        $ret[] = '/static/css/admin.css';
        $ret[] = '/static/css/content.css';
        return $ret;
    }
    ...
    protected function getScriptsUrls()
    {
        ...
        $ret[] = '/static/js/vendor/summernote.min.js';
        $ret[] = '/static/js/vendor/summernote-ext-video.js';
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo Action_Admin::lt(); ?>">Admin
				Panel</a>
		</div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="#contact">Contact</a></li>-->
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Website Data <span class="caret"></span></a>
					...
					<ul class="dropdown-menu" role="menu">
						<li>
							<form class="navbar-form" role="form"
								action="<?php echo Action_AdminLogin::lt() ?>" method="post">
